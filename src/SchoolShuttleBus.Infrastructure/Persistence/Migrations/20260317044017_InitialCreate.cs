        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CanManageAllRoutes = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    NotificationJobId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NotificationDeliveries_NotificationJobs_NotificationJobId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HandoffContactName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    HandoffContactPhone = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultRouteId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Students_Routes_DefaultRouteId",
                        column: x => x.DefaultRouteId,
                        principalTable: "Routes",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedByStaffProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AttendanceSessions_StaffProfiles_CreatedByStaffProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RouteAssignments_StaffProfiles_StaffProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DispatchOverrides", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DispatchOverrides_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DispatchOverrides_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RideRegistrations_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_RideRegistrations_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentGuardianLinks_Guardians_GuardianId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    EmergencyPhoneSnapshot = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    UpdatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_CreatedByStaffProfileId",
                table: "AttendanceSessions",
                column: "CreatedByStaffProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_AttendanceSessions_RouteId",
                table: "AttendanceSessions",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_DispatchOverrides_RouteId",
                table: "DispatchOverrides",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_DispatchOverrides_StudentId_Date_Direction_Status",
                table: "DispatchOverrides",
                columns: new[] { "StudentId", "Date", "Direction", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_NotificationDeliveries_NotificationJobId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RideRegistrations_RouteId",
                table: "RideRegistrations",
                column: "RouteId");

            migrationBuilder.CreateIndex(
                name: "IX_RideRegistrations_StudentId_Date_Direction",
                table: "RideRegistrations",
                columns: new[] { "StudentId", "Date", "Direction" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteAssignments_StaffProfileId",
                table: "RouteAssignments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentGuardianLinks_GuardianId",
                table: "StudentGuardianLinks",
                column: "GuardianId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentGuardianLinks_StudentId_GuardianId",
                table: "StudentGuardianLinks",
                columns: new[] { "StudentId", "GuardianId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Students_DefaultRouteId",
                table: "Students",
